...
<!-- Menu -->
    <div id="nav2" class="dropdown">
      <button class=" btn dropdown-toggle" data-toggle="dropdown">
        <h3>Choisir un monument</h3>
      </button>
      <ul class="dropdown-menu row filtres menu_styles filters">
        <li><a class="dropdown-item" href="" data-filter="*">Tous</a></li>
        <li><a class="dropdown-item" href="#" data-filter=".palais">Palais Impérial</a></li>
        <li><a class="dropdown-item" href="#" data-filter=".tombeF">Tombeau Fuling</a></li>
        <li><a class="dropdown-item" href="#" data-filter=".tombeN">Mausolée Zhaoling</a></li>
        <li><a class="dropdown-item" href="#" data-filter=".grotte">Grotte de Benxi</a></li>
        <li><a class="dropdown-item" href="#" data-filter=".mont">Mont Qian Shan</a></li>
        <li><a class="dropdown-item" href="#" data-filter=".3D">Objets en 3D</a></li>
      </ul>
    </div>
...
<!--************************************** FIN GALERIE *************************************-->
    ...
    <footer>
        <p class="m-0 text-center text-white">Merci pour les <a href="../../contact/contact.html">droits sur les images</a> &copy; Shenyang - 2018</p>
    </footer>
