...
<!-- Menu -->
    <div id="nav2" class="dropdown">
      ...
      <div class="dropdown-menu row filtres menu_styles filters">
        <a class="dropdown-item" href="" data-filter="*">All</a>
        <a class="dropdown-item" href="#" data-filter=".palais">Mukden Palace</a>
        <a class="dropdown-item" href="#" data-filter=".tombeF">Fuling Tomb</a>
        <a class="dropdown-item" href="#" data-filter=".tombeN">Zhaoling Mausoleum</a>
        <a class="dropdown-item" href="#" data-filter=".grotte">Benxi Cave</a>
        <a class="dropdown-item" href="#" data-filter=".mont">Mount Qian Shan</a>
        <a class="dropdown-item" href="#" data-filter=".3D">3D Objects</a>
      </div>
    </div>
...
<!--************************************** FIN GALERIE *************************************-->
    ...
    <footer>
        <p class="m-0 text-center text-white">Thanks for the <a href="../../contact/contact.html">rights about pictures</a> &copy; Shenyang - 2018</p>
    </footer>
