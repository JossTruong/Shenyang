...
<!--*************************************** Mise en Forme ************************************-->
			...
			<h1 align="center">Partager vos expériences</h1><br>
			<div>
			<div class="row">
			...
			<div class="col-md-12 col-lg-6">
				<form method="post" action="livreor.php" role="form">
					...
					<div>
						...
						<textarea name="message" rows="5" placeholder="Commentaire" maxlength="500" required></textarea></br>
					</div>
					<input class="bouton" type="submit" name="send" value="Envoyer">
				</form>
		</div>
	</div>
<!--************************************ Fin mise en forme ***********************************-->
...
//***********************************************************************************************
				...
				echo "<h1 style='text-align:center; margin-top:0px; margin-bottom:30px;'>Commentaire :</h1>";
				$stmt = $bdd->query($retour);
				while($row =$stmt->fetch()) {
				echo "<hr style='height:1px; background-color:rgba(255,255,255,0.1)'>";
					echo "<b><span style='color:#ea5c0d; font-size:20px; margin-left:20px;'>$row[pseudo]</b> le
					<b><i><span style='color:white'>$row[date]</i></b> à
